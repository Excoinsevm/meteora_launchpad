...
export class ApeClient {
  ...
  static async getChart(
    ...
    return ky
      .get(`${BASE_URL}/v6/charts/${assetId}`, {
  ...
  static async getTokenDescription(
    ...
    return ky.get(`${BASE_URL}/v6/assets/${assetId}/description`, options).json();
  }
}
